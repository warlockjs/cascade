...
type RestorerResult = {
   ...
   */
  conflicts?: Array<{
    /** The original ID that conflicted */id: string | number; /** Reason for the conflict */
    reason: string;
  }>;
};
//#endregion
export { RestorerContract, RestorerOptions, RestorerResult };
//# sourceMappingURL=database-restorer.contract.d.mts.map