...
type GenerateIdOptions = {
  /** The table/collection name */table: string; /** Initial ID value for the first record (default: 1) */
  initialId?: number; /** Amount to increment by for each new record (default: 1) */
...
//#endregion
export { GenerateIdOptions, IdGeneratorContract };
//# sourceMappingURL=database-id-generator.contract.d.mts.map