...
type DataSourceOptions = {
  /** Unique name identifying the data source. */name: string; /** Driver bound to the data source. */
  driver: DriverContract; /** Whether this data source should be considered the default one. */
  isDefault?: boolean;
  /**
...
//# sourceMappingURL=data-source.d.mts.map