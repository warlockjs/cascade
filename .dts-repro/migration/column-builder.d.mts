import { ColumnDefinition, ColumnType, ForeignKeyDefinition, VectorIndexOptions } from "../contracts/migration-driver.contract.mjs";

//#region ../../@warlock.js/cascade/src/migration/column-builder.d.ts
/**
...
declare class ColumnBuilder {
   ...
   * ```
   */
  vectorIndex(options?: Omit<VectorIndexOptions, "dimensions">): this;
  /**
   * Mark as primary key.
   *
   * @returns This builder for chaining
...
//# sourceMappingURL=column-builder.d.mts.map