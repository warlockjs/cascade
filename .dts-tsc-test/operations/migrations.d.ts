 ...
 */
export declare function rollbackMigrations(options?: RollbackMigrationsOptions): Promise<MigrationResult[]>;
/**
 ...
 * await freshMigrate();
 */
export declare function freshMigrate(): Promise<MigrationResult[]>;
/**
 ...
 */
export declare function exportMigrationsSQL(options?: ExportMigrationsSQLOptions): Promise<void>;
/**
 ...
 */
export declare function listExecutedMigrations(): Promise<MigrationRecord[]>;
