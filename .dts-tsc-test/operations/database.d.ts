 ...
 */
export declare function createDatabase(name: string, options?: DataSourceSelector): Promise<CreateDatabaseResult>;
/**
 ...
 */
export declare function dropAllTables(options?: DataSourceSelector): Promise<DropAllTablesResult>;
export {};
