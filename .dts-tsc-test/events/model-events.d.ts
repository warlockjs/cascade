 ...
 */
export type ModelEventName = "initializing" | "fetching" | "hydrating" | "fetched" | "validating" | "validated" | "saving" | "saved" | "creating" | "created" | "updating" | "updated" | "deleting" | "deleted" | "restoring" | "restored";
/** Signature of an event listener registered against a model lifecycle hook. */
export type ModelEventListener<TModel, TContext = unknown> = (model: TModel, context: TContext) => void | Promise<void>;
/**
 ...
 */
export declare class ModelEvents<TModel> {
 ...
 */
export declare const globalModelEvents: ModelEvents<Model<import("../model/model.types").ModelSchema>>;
export {};
